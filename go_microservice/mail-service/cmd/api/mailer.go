...
func (m *Mail) SendSMTPMessage(msg Message) error {
	...
	plainMessage, err := m.buildPlainTextMessage(msg) // plain text email format
	if err != nil {
		return err
	}
	...
	server.Encryption = m.getEncryption(m.Encryption) // supports many mail servers
