...
// Model, which embeds all the types for the app
...
// holds one user from the database.
type User struct {
	ID        int       `json:"id"`
...
// updates one user in the database, using the information stored in the receiver 
...
// deletes one user from the database, by User.ID
